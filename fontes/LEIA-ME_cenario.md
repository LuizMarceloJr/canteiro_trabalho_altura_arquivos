...
| **`canteiro_trabalho_altura_arquivos/jogo/`** | **O jogo**: aula + prova de escolha e consequência rodando sobre o `.glb` e o `roteiro_treinamento.json`. Abra com `jogo/abrir_jogo.bat`. Ver `jogo/LEIA-ME_jogo.md` |
